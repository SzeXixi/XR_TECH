    ...
    public class ModuleInteractor : MonoBehaviour
    {
        ...
        private void Awake()
        {
            switch (moduleType)
            {
                ...
                //     UpdateInteractor(ButtonMouseEventInput.Instance, transform);
                //     ButtonMouseEventInput.OnReleaseButtonMouseModule += DestroySelf;
                //     break;
                // case InputModuleType.TouchPad:
                //     UpdateInteractor(TouchPadEventInput.Instance, transform);
                //     TouchPadEventInput.OnReleaseTouchPadModule += DestroySelf;
                //     break;
            }
        }
